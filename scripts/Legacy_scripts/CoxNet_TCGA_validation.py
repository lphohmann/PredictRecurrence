...
infile_testset_coxresults = "./output/CoxNet_unadjusted/Selected_model/testset_univariate_cox.csv" # ⚠️ ADAPT
...
uv_res_tcga = uv_res
uv_res_scanb = pd.read_csv(infile_testset_coxresults)

merged_uv_res = uv_res_scanb.merge(uv_res_tcga, on="CpG_ID", how="left", suffixes=("_scanb", "_tcga"))

# Limit columns and format floats nicely for logging
print(
    merged_uv_res[["CpG_ID", "HR_scanb", "pval_scanb", "HR_tcga", "pval_tcga"]]
    .sort_values(by="CpG_ID")
