...
#-------------------
# output paths
outfile_1 <- paste0(output_path, "PC_Train_table1.html")
outfile_2 <- paste0(output_path, "PC_Test_table1.html")
outfile_3 <- paste0(output_path, "PC_TestVsTrain_table1.html")
#-------------------
# storing objects 
table_list <- list()
